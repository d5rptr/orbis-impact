    ...
    <div className="bg-accent text-darkBlue font-sans py-8 px-4 md:px-8">
      <div className="container mx-auto max-w-4xl">
        ...
        <p className="mb-4">
          ...
          data and materials thereon, the look and feel, design and organization of the Website, and
          the compilation of the content, code, data and materials on the Website, including but not
          limited to any copyrights, trademark rights, patent rights, database rights, moral rights,
          sui generis rights and other intellectual property and proprietary rights therein. Your
          use of the Website does not grant to you ownership of any content, code, data or materials
          you may access on or through the Website.
        </p>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-4">Prohibited User Conduct</h2>
        <p className="mb-4">
          You warrant and agree that, while using the Website, you shall not attempt to gain
          unauthorized access to computer systems or engage in any activity that could impair the
          Website.
        </p>
